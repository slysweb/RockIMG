...
LANG = {
    ...
    "tool.water_reflection_generator": "Water Reflection Generator",
    ...
    "tool.gif_to_livp": "GIF to Live Photo",
    "tool.livp_to_photo": "Live Photo to Photo",
    "tool.livp_to_gif": "Live Photo to GIF",
    ...
    "tool.mp3_album_cover": "MP3 Album Cover (Add)",
    "tool.mp3_cover_extract": "MP3 Cover Extract",
    ...
    "tool.ccd_style": "CCD Style",
    "tool.rubbing_effect": "Rubbing Effect",
    "tool.color_blind_test": "Color Blind Test",
    "tool.color_blindness_simulator": "Color Blindness Simulator",
    "tool.eye_test_chart": "Eye Test Chart",
    "tool.get_image_color": "Get Image Color",
    "tool.image_coords": "Image Coordinate Picker",
    "tool.glitch_effect": "Glitch Effect",
    "tool.optical_illusion_generator": "Optical Illusion Generator",
    "tool.motion_aftereffect_generator": "Motion Aftereffect Generator",
    "tool.image_filters": "Image Filters",
    "tool.image_to_pixel_art": "Image to Pixel Art",
    "tool.low_quality_image_maker": "Low Quality Image Maker",
    "tool.perler_bead_pattern_maker": "Perler Bead Pattern Maker",
